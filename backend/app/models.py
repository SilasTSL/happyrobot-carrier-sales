...
class CallRecord(Base):
    ...
    # Load reference — nullable because not_eligible and no_match outcomes never bind to a load
    ...
    # Rate snapshot — intentionally denormalized: loads get re-seeded and rates change,
