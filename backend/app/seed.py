...
from app.models import CallRecord, Load, OutcomeEnum, SentimentEnum

logger = logging.getLogger(__name__)

_SEED_FILE = Path(__file__).parent.parent / "seed_loads.json"

# Each spec references a load by its 0-based insertion order (load_index).
# None means the outcome never reached a load (not_eligible, no_match, early hung_up).
# final_rate must fall between loadboard_rate and max_rate for the referenced load.
_CALL_RECORD_SPECS = [
    # --- booked (10) ---
    {
